...
export class AuthService {
  ...
  SignUp(email : string, password : string ){
    return this.http.post<AuthResponse>('https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAT7Zhy3c43aeU2bVaiEhhNweyKnyo2Bt8', 
    {
      email : email,
      password : password,
  ...
  LogIn(email : string, password : string){
    return this.http.post<AuthResponse>('https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAT7Zhy3c43aeU2bVaiEhhNweyKnyo2Bt8',
     {
      email : email,
      password : password,
      returnSecureToken:true
